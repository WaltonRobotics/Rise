...
public class CompRise implements WaltRobot {
    ...
    private final PIDController leftVelocityPIDController = new PIDController(1, 0, 0);
    private final PIDController rightVelocityPIDController = new PIDController(1, 0, 0);
