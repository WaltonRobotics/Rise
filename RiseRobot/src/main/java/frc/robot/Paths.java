...
//        public static Trajectory generatorBackupToShoot = generateTwoGeneratorBackupToShoot();
        ...
        public static Trajectory generateTwoTrenchPickup() {
            ...
            return TrajectoryGenerator.generateTrajectory(
                    Arrays.asList(new Pose2d(Units.feetToMeters(10.609), Units.feetToMeters(19.13), Rotation2d.fromDegrees(50)),
                            new Pose2d(Units.feetToMeters(17.916), Units.feetToMeters(24), Rotation2d.fromDegrees(0))),
                    config
            );
        }
        ...
        public static Trajectory generateTwoIntakeThreeBalls() {
            ...
            return TrajectoryGenerator.generateTrajectory(
                    Arrays.asList(new Pose2d(Units.feetToMeters(17.916), Units.feetToMeters(24), Rotation2d.fromDegrees(0)),
                            new Pose2d(Units.feetToMeters(25.678), Units.feetToMeters(24), Rotation2d.fromDegrees(0))),
                    config
            );
        }
        ...
        public static Trajectory generateTwoGoShoot() {
            ...
            return TrajectoryGenerator.generateTrajectory(
                    Arrays.asList(new Pose2d(Units.feetToMeters(25.678), Units.feetToMeters(24), Rotation2d.fromDegrees(0)),
                            new Pose2d(Units.feetToMeters(15.886), Units.feetToMeters(18.522), Rotation2d.fromDegrees(45))),
                    config
            );
        }
    ...
    public static class Four {
        ...
        public static class Five {
            ...
            public static Trajectory generateFiveThreeBallTrenchPickUp() {
                ...
                return TrajectoryGenerator.generateTrajectory(
                        Arrays.asList(new Pose2d(Units.feetToMeters(17.047), Units.feetToMeters(13.224), Rotation2d.fromDegrees(150.0)),
                                new Pose2d(Units.feetToMeters(15.114), Units.feetToMeters(17.862), Rotation2d.fromDegrees(90.0)),
                            new Pose2d(Units.feetToMeters(17.575), Units.feetToMeters(24.658), Rotation2d.fromDegrees(0.0)),
                        new Pose2d(Units.feetToMeters(25.748), Units.feetToMeters(24.704), Rotation2d.fromDegrees(0.0))),
                        config
                );
            }
            ...
            public static Trajectory generateFromTrenchToGenerator() {
                ...
                return TrajectoryGenerator.generateTrajectory(
                        Arrays.asList(new Pose2d(Units.feetToMeters(25.748), Units.feetToMeters(24.704), Rotation2d.fromDegrees(0.0)),
                                new Pose2d(Units.feetToMeters(20.0), Units.feetToMeters(20.066), Rotation2d.fromDegrees(-70.0))),
                        config
                );
            }
